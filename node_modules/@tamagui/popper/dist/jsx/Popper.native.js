...
function Popper(props) {
  var _middlewareData_checkFloating, children = props.children, size = props.size, _props_strategy = props.strategy, strategy = _props_strategy === void 0 ? "absolute" : _props_strategy, _props_placement = props.placement, placement = _props_placement === void 0 ? "bottom" : _props_placement, stayInFrame = props.stayInFrame, allowFlip = props.allowFlip, offset = props.offset, disableRTL = props.disableRTL, __scopePopper = props.__scopePopper, isMounted = useDidFinishSSR(), _React_useState = _sliced_to_array(React.useState(null), 2), arrowEl = _React_useState[0], setArrow = _React_useState[1], _React_useState1 = _sliced_to_array(React.useState(0), 2), arrowSize = _React_useState1[0], setArrowSize = _React_useState1[1], offsetOptions = offset ?? arrowSize, floating = useFloating({
    ...
    platform: disableRTL ?? setupOptions.disableRTL ? _object_spread_props(_object_spread({}, platform), {
...
var PopperAnchor = YStack.extractable(/* @__PURE__ */ React.forwardRef(function(props, forwardedRef) {
  ...
  var _context_arrowStyle, _context_arrowStyle1, __scopePopper = propsIn.__scopePopper, rest = _object_without_properties(propsIn, [
    ...
    "size",
    "borderWidth"
  ]), context = usePopperContext(__scopePopper), sizeVal = typeof sizeProp == "number" ? sizeProp : getVariableValue(getSpace(sizeProp ?? context.size, {
    shift: -2,
    bounds: [
      2
    ]
